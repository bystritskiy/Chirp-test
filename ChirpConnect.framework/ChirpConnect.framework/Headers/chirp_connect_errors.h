...
typedef enum {
    CHIRP_CONNECT_OK = 0,
    CHIRP_CONNECT_OUT_OF_MEMORY_ERROR,
    ...
    CHIRP_CONNECT_MISSING_LICENCE,
    CHIRP_CONNECT_INVALID_LICENCE,
    CHIRP_CONNECT_EXPIRED_LICENCE,
    CHIRP_CONNECT_INVALID_VERSION,
    CHIRP_CONNECT_INVALID_PROJECT,
    /*--------------------------------------------------------------------------
     * CHIRP_CONNECT_INVALID_LICENCE_CHARACTER needs to be kept at the end of
     * the credentials error code list as it deals with base64 but it is
     * implemented in chirp-connect.
     *------------------------------------------------------------------------*/
    CHIRP_CONNECT_INVALID_LICENCE_CHARACTER,
